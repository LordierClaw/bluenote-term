...
3. In `../bluenote-term`, update the dependency to either `file:../bluenote-core`, a Git tag such as `github:LordierClaw/bluenote-core#v0.1.0`, or a future npm range such as `^0.1.0`.
