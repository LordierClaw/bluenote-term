...
- Humanize timestamps: `Updated 2m ago`, `Saved just now`, `Updated May 29`.
...
- Editor at high zoom/low height: show `Line/Col`, save pill, and compact `? shortcuts`; hide full shortcut row.
...
- Footer shows prioritized actions: `[Enter] Open`, `[n] New`, `[s] Search`, `[?] More`.
