...
- accepted Phase 4F TUI cleanup/navigation/filtering/save behavior: Manager topbar filtered count, currently-open note footer label, filtered result navigation, editor border/title removal, editor topbar/bottom bar contract, and real TTY smoke coverage for autosave and manager switching after edit
