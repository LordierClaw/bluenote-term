...
- The current shared-testing dependency is the reproducible Git commit `"@lordierclaw/bluenote-core": "github:LordierClaw/bluenote-core#26586e011e04"`; active local core development may temporarily use `file:../bluenote-core`, and future npm releases should use a semver range such as `^0.4.0`. Do not depend on `#main` for normal releases.
