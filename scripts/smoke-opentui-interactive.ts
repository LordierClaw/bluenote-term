...
try {
  ...
  sendKeys(sessionName, "Escape")
  capturePaneUntil(sessionName, "switch target return to manager before Right attempt", "[Enter] Open", 20)
  sendKeys(sessionName, "Right")
  ...
  sendKeys(sessionName, "Escape")
  capturePaneUntil(sessionName, "switch target return to manager for original editor", "[Enter] Open", 20)
  ...
  sendKeys(sessionName, "Escape")
  const managerReturnPane = capturePaneUntil(sessionName, "editor return to manager", "[Enter] Open", 20)
  expectPaneContains(managerReturnPane, "Root Editor", "editor return to manager")
  expectLatestScreen(managerReturnPane, "[Enter] Open", "[Ctrl+F] Find", "editor return to manager latest screen")
